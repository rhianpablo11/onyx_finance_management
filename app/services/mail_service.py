...
def send_email(email: str, code: int, isRecovery: bool, name: str = ''):
    ...
    if(isRecovery):
        assunto = 'Onyx - Código para recuperar a senha'
        html_content = f"""
        <!DOCTYPE html>
        <html lang="pt-BR">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px; text-align: center; background-image: url('{API_SELF_URL}/static/logo-onyx-watermark.png'); background-repeat: no-repeat; background-position: center center; background-size: 40%;">
                                    ...
                                    <h2 style="color: #18181b; margin-top: 0;">Olá {name}, falta pouco para recuperar sua senha!</h2>
                                    
                                    <p style="color: #52525b; font-size: 16px; line-height: 1.5; margin-bottom: 30px;">
                                        Recebemos um pedido de recuperação de senha para o seu email. Use o código de 6 dígitos abaixo para continuar:
                                    </p>
                                    ...
                                    <p style="color: #71717a; font-size: 14px;">
                                        Este código <strong>expira em 5 minutos</strong>. Se você não solicitou este código, pode ignorar este email com segurança.  É importante salientar, <strong>não compartilhe esse código com ninguem</strong>. Este código é de uso pessoal e intransferivel.
                                    </p>
                                    <p style="color: #71717a; font-size: 14px;">
