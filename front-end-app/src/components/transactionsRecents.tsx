                    ...
                    <div className="flex justify-between text-white font-extralight text-sm relative pb-2">
                        ...
                        <div 
                            className={`absolute bottom-0 h-px w-1/3 transition-all duration-500 ease-in-out
                                ${activeTab === 0 ? "translate-x-0 bg-linear-to-r from-violet-900 to-transparent" : ""}
                                ${activeTab === 1 ? "translate-x-full bg-linear-to-r from-transparent via-violet-900 to-transparent" : ""}
                                ${activeTab === 2 ? "translate-x-[200%] bg-linear-to-l from-violet-900 to-transparent" : ""}
                            `}
                        >
                            {/* Opcional: Um brilho extra (glow) para ficar neon */}
                            <div className="absolute inset-0 bg-violet-900 blur-[2px] opacity-50"></div>
                        </div>
                    </div>
